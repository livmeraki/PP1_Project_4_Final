...
<main role="main">
	...
	<section class="jumbotron jumbotron-fluid">
		<div class="container">
			<div >
				<h1 class = "d-flex justify-content-center">E D I T</h1>
			...
			<form action="editpost.jsp" method="post">
				<input type="hidden" name="id" value="<%=u.getId()%>"/>
					<div style="display:flex;flex-direction:row">
						<input type="text" name="title" value="<%=u.getTitle()%>" placeholder="Title" style="flex:1; font-size:35px"/> <br>
					</div>
				<div style="display:flex;flex-direction:row">
						<textarea cols="50" rows="5" name="content" placeholder="Content" style="flex:1"><%=u.getContent()%></textarea> <br>
				</div>
				<fieldset>
